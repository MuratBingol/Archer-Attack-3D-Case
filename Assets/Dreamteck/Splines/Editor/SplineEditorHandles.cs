namespace Dreamteck.Splines.Editor
{
    ...
    public static class SplineEditorHandles
    {
        ...
        {
            var fmh_48_53_638249786059665102 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
        }

        public static Vector3 FreeMoveCircle(Vector3 position, float size)
        {
            var fmh_53_53_638249786059686433 = Quaternion.identity; return Handles.FreeMoveHandle(position, size, Vector3.zero, Handles.CircleHandleCap);
        }
